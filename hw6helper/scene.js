...
*/
var o1 = new THREE.Vector3(209.52434509802094,0,200.3504031550267);
var o2 = new THREE.Vector3(-203.9594796502145093,0,203.55695318495896);
var o3 = new THREE.Vector3(5.42098955335508,0,-160.53706110138933);
var o4 = new THREE.Vector3(0,0,60);
function checkisincircle(target){
	if(target.distanceTo(o1)<40+5)
		return true;
	else if(target.distanceTo(o2)<50+5)
		return true;
	else if(target.distanceTo(o3)<60+5)
		return true;
	else if(target.distanceTo(o4)<30+5)
		return true;
	else
		return false;
}
function sceneFromJSON () {//改亂數
  ...
  const JSONStr = '{"obstacles":[{"center":{"x":'+o1.x+',"y":'+o1.y+',"z":'+o1.z+'},"size":40},{"center":{"x":'+o2.x+',"y":'+o2.y+',"z":'+o2.z+'},"size":50},{"center":{"x":'+o3.x+',"y":'+o3.y+',"z":'+o3.z+'},"size":60},{"center":{"x":'+o4.x+',"y":'+o4.y+',"z":'+o4.z+'},"size":30}]}';
